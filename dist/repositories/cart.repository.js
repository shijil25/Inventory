...
var CartRepository = /** @class */ (function () {
    ...
    CartRepository.prototype.findAll = function () {
        return typeorm_1.getManager().getRepository(cart_entity_1.Cart).find();
    };
    /**
     * Finds by id
     * @param id
    ...
    CartRepository.prototype.findById = function (id) {
        return typeorm_1.getManager().getRepository(cart_entity_1.Cart).findOne({
            relations: ['Product'],
            where: { CartID: id }
        });
    };
    ...
    CartRepository.prototype.delete = function (id) {
        return typeorm_1.getManager().getRepository(cart_entity_1.Cart).delete(id);
    };
