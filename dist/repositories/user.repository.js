...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.findById = function (id) {
        return typeorm_1.getManager().getRepository(user_entity_1.User).findOne(id);
    };
    /**
    ...
    UserRepository.prototype.update = function (id, user) {
        return typeorm_1.getManager().getRepository(user_entity_1.User).update(id, user);
    };
    /**
    ...
    UserRepository.prototype.delete = function (id) {
        return typeorm_1.getManager().getRepository(user_entity_1.User).delete(id);
    };
