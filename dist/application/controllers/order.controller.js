...
var OrderController = /** @class */ (function () {
     ...
     */
    function OrderController(orderService, eventPublishService, loggerService) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._orderService.findById(+req.params.id)];
                    case 1:
                        result = _a.sent();
                        if (!result.IsSuccess) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._orderService.findByUser(+req.params.id)];
                    case 1:
                        result = _a.sent();
                        if (!result.IsSuccess) {
                            res.status(404).json(result.ErrorMessage);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._orderService.create(req.body.userId)];
                    case 1:
                        result = _a.sent();
                        if (!result.IsSuccess) {
                            res.status(404).json(result.ErrorMessage);
