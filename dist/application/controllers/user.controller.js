...
var UserController = /** @class */ (function () {
     ...
     * @param userService
     */
    function UserController(userService, loggerService) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.userService.findById(+req.params.id)];
                    case 1:
                        result = _a.sent();
                        if (!result) {
                            res.status(404).json(result.ErrorMessage);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        user = new index_1.UserDTO(0, req.body.lastName, req.body.firstName, req.body.userType, req.body.email, req.body.userName, req.body.password);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        user = new index_1.UserDTO(0, req.body.lastName, req.body.firstName, req.body.userType, req.body.email, req.body.userName, req.body.password);
                        return [4 /*yield*/, this.userService.update(+req.params.id, user)];
                    case 1:
                        result = _a.sent();
                        if (result.IsSuccess) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.userService.delete(+req.params.id)];
                    case 1:
                        result = _a.sent();
                        if (result.IsSuccess) {
